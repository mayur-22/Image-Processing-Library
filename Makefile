...
main: main.o DtException.o convolution.o Matrix.o Tanh.o pooling.o softmax.o sigmoid.o RElu.o LetNet.o
	$(CXX) $(CXXFLAGS) -o main main.o DtException.o convolution.o Matrix.o Tanh.o pooling.o softmax.o sigmoid.o RElu.o LetNet.o -m64 -I ~/intel/mkl/include -L~/intel/mkl/lib/intel64 -Wl,--no-as-needed ~/intel/mkl/lib/intel64/libmkl_scalapack_lp64.a ~/intel/mkl/lib/intel64/libmkl_intel_lp64.a ~/intel/mkl/lib/intel64/libmkl_gnu_thread.a ~/intel/mkl/lib/intel64/libmkl_core.a ~/intel/mkl/lib/intel64/libmkl_blacs_intelmpi_lp64.a -lgomp -lpthread -lm -ldl

main.o: DtException.h Matrix.h tanh.h softmax.h pooling.h convolution.h RElu.h LetNet.h

LetNet.o: LetNet.h Matrix.h pooling.h RElu.h convolution.h 
